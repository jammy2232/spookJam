...
public class PlayerController : MonoBehaviour, IHealth {
	...
	void Start ()
    {
        ...
        if (playerNumber == PlayerNumber.PLAYER1 && Input.GetJoystickNames().Length == 2)
        {
    ...
    public void TakeDamage(int damage, float hitAngle)
    {
        ...
        playerRenderer.TintSprite(new Color(1.0f, redValue, redValue));
    ...
    {
        playerState = PLAYERSTATE.dead;
        playerRenderer.TintSprite(Color.grey);
        health = 0;
    }
